...
/**
 * An adaption of TestEventListener that never prints debug logs itself. Use together with [[WithLogCapturing]].
...
/**
 * An adaption of TestEventListener that does not print out any logs. Use together with [[WithLogCapturing]].
